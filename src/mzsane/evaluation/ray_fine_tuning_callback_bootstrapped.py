...
# SHRP
from mzsane.sampling.kde_sample_bootstrapped import sample_model_evaluation_bootstrapped

from mzsane.models.def_AE_module import AEModule
from mzsane.models import tiny_imagenet_helpers
import torch
...
class CheckpointSamplingCallbackBootstrapped(Callback):
    def __init__(
        ...
        repetitions: int,
        anchor_ds_path: Optional[Union[str, Path, ]],  # Path to anchor dataset
        ...
        if layer_norms_path is not None:
        ...
        self.reference_dataset_ref = reference_dataset_ref
        self.anchor_ds_ref = anchor_ds_ref
    ...
    def on_validation_epoch_end(self, ae_model, iteration) -> None:
        ...
        metrics_dict = sample_model_evaluation_bootstrapped(
            ...
            anchor_ds_ref=self.anchor_ds_ref,
            reference_dataset_ref=self.reference_dataset_ref
        )
