# downstream module for windows of models. 
# This module is used to evaluate the performance of the learned representations on downstream tasks.
import torch
...
class DownstreamTaskLearner:
    ...
    It expects (windows of) sample-wise embeddings and target values.
