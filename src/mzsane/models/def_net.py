...
from mzsane.models.modules.mixup_cutmix_randerase_aug import get_data_augmentations
from mzsane.models.modules.info_nce_loss import InfoNCELoss
...
from mzsane.models.def_resnet_width import ResNet_width
...
class NNmodule(nn.Module):
    ...
    def train_epoch(self, trainloader, epoch, idx_out=10):
        ...
        for idx, data in enumerate(trainloader):
            ...
            if attention_mask is not None:
                loss, correct = self.train_step(x=input, target=target, attention_mask=attention_mask)
            else:
